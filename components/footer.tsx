...
export const Footer = () => {
  return (
    <div>
      ...
      {/* Desktop */}
      <div
        className={" mx-8  border-t-[1px] border-b-[1px] border-[#E4E4E4] font-poppins py-4"}
      >
        <div className={"text-[12px] font-bold text-center"}>
          <ul className={"hover:text-[#DE1B55] text-[#171433]"}>
            <li>
        ...
        <p className={"py-4 text-xs text-[#171433] text-center font-poppins"}>
