...
export const Error = () => {
  return (
    <div className="grid w-full h-screen place-content-center font-poppins lg:grid-cols-4">
      <div className="absolute inset-0 w-full h-screen -z-10 ">
        <div className="grid h-full w-full  lg:grid-rows-[1fr_auto]">
          <div className="relative w-full overflow-hidden -z-10">
            ...
            <div className="md:-translate-x-34 absolute bottom-0 -translate-x-20 translate-y-8 scale-[4] sm:-translate-x-10 sm:translate-y-14 sm:scale-[3.3] md:translate-y-28 md:scale-[3]  lg:translate-x-0 lg:translate-y-14 lg:scale-[1.5] xl:translate-x-0 xl:translate-y-20   2xl:translate-y-40 2xl:translate-x-36  3xl:translate-y-[5%]   3xl:translate-x-30 4xl:scale-[1.4] 4xl:translate-x-0  4xl:translate-y-40  5xl:translate-x-24 5xl:translate-y-[20%]">
              <Image
                src={Creative}
      ...
      <div className="grid w-full gap-8 tracking-wide lg:mx-10 font-poppins sm:px-24 md:px-20 lg:col-span-3">
        <div>
          <h1
            className={
